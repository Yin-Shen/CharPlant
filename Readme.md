...
&emsp;&emsp;&emsp;When using the tool, kindly acknowledge the project contribution by citing the following papers: Yin Shen, Ling-Ling Chen, and Junxiang Gao*. CharPlant: a de novo prediction tool of chromatin accessible regions for plant genomes. (Submitted to *Plant Biotechnology Journal*)
